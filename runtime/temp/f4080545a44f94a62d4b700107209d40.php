<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\phpStudy\WWW\cp/application/adminz\view\tixian\index.html";i:1545183318;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1545183312;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  var element = layui.element;
	...
	<script type="text/javascript">
		...
		function getData(p){
			...
			$.post("<?php echo url('tixian/get_tixian_list'); ?>",{page:p},function(res){
				if(res.code == 1){
