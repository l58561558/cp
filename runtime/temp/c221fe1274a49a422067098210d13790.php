<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\phpStudy\WWW\cp/application/adminz\view\role\index.html";i:1512973942;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
				...
				<div class="box">
					<div class="box-header with-border">
		              ...
		              <div class="pull-right">
			              <a href="<?php echo url('role/add'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;添加角色</a>
			          </div>
		            </div>
  ...
  var element = layui.element;
	...
	<script type="text/javascript">
		function getData(p){
			if(p==undefined || p<1)
				p = 1;
			$.post("<?php echo url('role/get_role_list'); ?>",{page:p},function(res){
				if(res.code == 1){
