<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\phpStudy\WWW\cp/application/adminz\view\admin\index.html";i:1545183300;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1545183312;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
				...
				<div class="box">
					<div class="box-header with-border">
		              ...
		              <div class="pull-right">
			              <a href="<?php echo url('admin/add'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;添加管理员</a>
			          </div>
		            </div>
  ...
  var element = layui.element;
	...
	<script type="text/javascript">
		function getData(p){
			if(p==undefined || p<1)
				p = 1;
			$.post("<?php echo url('admin/get_admin_list'); ?>",{page:p},function(res){
				if(res.code == 1){
