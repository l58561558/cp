<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\phpStudy\WWW\cp/application/adminz\view\admin\add_root.html";i:1536137640;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                        ...
                        <div class="box-body" id="tab_base">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <select name="node_id" lay-verify="required" class="layui-input">
                                        <?php if(is_array((isset($root_list) && ($root_list !== '')?$root_list:array())) || (isset($root_list) && ($root_list !== '')?$root_list:array()) instanceof \think\Collection || (isset($root_list) && ($root_list !== '')?$root_list:array()) instanceof \think\Paginator): $i = 0; $__LIST__ = (isset($root_list) && ($root_list !== '')?$root_list:array());if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
