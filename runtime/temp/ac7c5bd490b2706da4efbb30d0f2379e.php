<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\phpStudy\WWW\cp/application/adminz\view\sell\add.html";i:1544627392;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">添加销售</h3>
                        <div class="pull-right">
                            <a href="<?php echo url('sell/personnel'); ?>" class="btn btn-link btn-sm"><i class="fa fa-angle-double-left"></i>&nbsp;返回列表</a>
                        </div>
                    </div>
                    ...
                    <form id="form_submit" enctype="multipart/form-data" class="layui-form layui-form-pane" action="" method="post">
                        ...
                        <div class="layui-input-block">
                            ...
                            <label for="jump_list" style="margin-left: 15px;"><input type="checkbox" data-url="<?php echo url('sell/personnel'); ?>" id="jump_list" value="1" >返回列表页</label>
                        </div>
                    </form>
                </div>
            </div>
