<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\phpStudy\WWW\cp/application/adminz\view\admin\add_money.html";i:1545183299;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1545183312;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                        ...
                        <div class="box-body" id="tab_base">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="yhid" lay-verify="required" class="layui-input" placeholder="用户ID" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">数量</label>
                                <div class="layui-input-block">
                                    <input type="text" name="price" lay-verify="required" class="layui-input" placeholder="数量" >
                                </div>
                            </div>
                        </div></div>
                        <div class="layui-input-block">
