<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\phpStudy\WWW\cp/application/adminz\view\account_details\index.html";i:1545615994;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1545616011;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<script type="text/javascript">
	...
	function getData(p){
		...
		$.post("<?php echo url('account_details/get_account_details_list'); ?>",result,function(res){
			if(res.code == 1){
