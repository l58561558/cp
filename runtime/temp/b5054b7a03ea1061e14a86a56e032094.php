<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\phpStudy\WWW\cp/application/adminz\view\sell\look_user.html";i:1544623106;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
				...
				<div class="box">
					<div class="box-header with-border">
						...
						<div class="pull-right">
							<a href="<?php echo url('sell/look_user'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;查看用户</a>
							<a href="<?php echo url('sell/add'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;添加销售</a>
						</div>
		            </div>
		            <div class="pull-left">
...
<script type="text/javascript">
	...
	function getData(){
		...
		$.post("<?php echo url('sell/get_look_user_list'); ?>",result,function(res){
			if(res.code == 1){
