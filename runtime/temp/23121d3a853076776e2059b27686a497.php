<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\phpStudy\WWW\cp/application/adminz\view\football\look.html";i:1543805466;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right">
                            <a href="<?php echo url('football/index'); ?>" class="btn btn-link btn-sm"><i class="fa fa-angle-double-left"></i>&nbsp;返回列表</a>
                        </div>
                    </div>
                        ...
                        <div class="layui-row layui-col-space15">
                            <div class="layui-col-md12">
                                <div class="layui-card">
                                    <div class="layui-card-body">比赛名称 ： <?php echo $data['game_name']; ?></div>
                                    <div class="layui-card-body">赛事状态 ： 
                                        <?php if($data['status'] == 0): ?><font style="text-align: center;color: red">已结算</font><?php endif; if($data['status'] == 1): ?><font style="text-align: center;color: red">停止投注</font><?php endif; if($data['status'] == 2): ?><font style="text-align: center;color: green">可以投注</font><?php endif; ?>
                                    </div>
                                    <div class="layui-card-body">主队 ： <?php echo $data['home_team']; ?></div>
                                    <div class="layui-card-body">客队 ： <?php echo $data['road_team']; ?></div>
                                    <div class="layui-card-body">停止投注时间 ： <?php echo $data['end_time']; ?></div>
                                    <div class="layui-card-body">上半场比分 ： <?php echo (isset($data['top_score']) && ($data['top_score'] !== '')?$data['top_score']:'-'); ?></div>
                                    <div class="layui-card-body">最终比分 ： <?php echo (isset($data['down_score']) && ($data['down_score'] !== '')?$data['down_score']:'-'); ?></div>
                                    <div class="layui-card-body">总球数 ： <?php echo (isset($data['total_score']) && ($data['total_score'] !== '')?$data['total_score']:'-'); ?></div>
                                    <div class="layui-card-body">让球数 ： <?php echo (isset($data['let_score']) && ($data['let_score'] !== '')?$data['let_score']:'-'); ?></div>
                                    <?php if(is_array($data['cate']) || $data['cate'] instanceof \think\Collection || $data['cate'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['cate'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                                    <div class="layui-card-body"><?php echo $item['cate_name']; ?>赔率 ： <?php echo $item['cate_odds']; ?></div>
