<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\phpStudy\WWW\cp/application/adminz\view\tpl\order_list.html";i:1545704554;}*/ ?>
<table class="layui-table table">
  ...
  <thead>
    ...
    <tr>
		...
		<td style="text-align: center;"><?php echo (isset($info['order_type']) && ($info['order_type'] !== '')?$info['order_type']:'-'); ?></td>
		...
		<!-- <td style="text-align: center;"><?php echo (isset($info['is_win']) && ($info['is_win'] !== '')?$info['is_win']:'-'); ?></td> -->
		...
		<td style="text-align: center;">
	      	<div class="btn-group btn-group-sm">
				<a href="<?php echo url('order/order_info'); ?>?order_id=<?php echo $info['order_id']; ?>">查看明细</a>
			</div>
		</td>
    </tr>
