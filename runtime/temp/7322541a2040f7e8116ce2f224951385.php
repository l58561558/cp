<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\phpStudy\WWW\cp/application/adminz\view\admin\add.html";i:1544535005;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <div class="box">
                    ...
                    <form id="form_submit" enctype="multipart/form-data" class="layui-form layui-form-pane" action="" method="post">
                        <div class="box-body" id="tab_base">
                            ...
                            <div class="layui-form-item aihao" style="display: none">
                                <label class="layui-form-label">上级角色</label>
                                <div class="layui-input-block">
                                    <select name="pid">
                                        <option value="1">无</option>
                                        <?php if(is_array((isset($p_user) && ($p_user !== '')?$p_user:array())) || (isset($p_user) && ($p_user !== '')?$p_user:array()) instanceof \think\Collection || (isset($p_user) && ($p_user !== '')?$p_user:array()) instanceof \think\Paginator): $i = 0; $__LIST__ = (isset($p_user) && ($p_user !== '')?$p_user:array());if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" datatype="*" nullmsg="请输入登录名"  name="login_name" lay-verify="required" class="layui-input" placeholder="登录名" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">姓名</label>
                                <div class="layui-input-block">
                                    <input type="text" datatype="*" nullmsg="请输入姓名" name="nickname" lay-verify="required" class="layui-input" placeholder="姓名" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" datatype="*" nullmsg="请输入手机号码" name="mobile" lay-verify="required" class="layui-input" placeholder="手机号码" >
                                </div>
                            </div>
                            <!-- <div class="layui-form-item">
                                <label class="layui-form-label">状态</label>
                                <div class="layui-input-block">
                                    <input type="radio" id="status_yes" name="status" value="启用" title="启用" checked="">
                                    <div class="layui-unselect layui-form-radio layui-form-radioed">
                                        <i class="layui-anim layui-icon layui-anim-scaleSpring"></i>
                                        <div>启用</div>
                                    </div>
                                    <input type="radio" id="status_no" name="status" value="禁用" title="禁用">
                        ...
                        <div class="layui-input-block">
                            ...
                            <label for="jump_list" style="margin-left: 15px;"><input type="checkbox" data-url="<?php echo url('admin/index'); ?>" id="jump_list" value="1" >返回列表页</label>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        layui.use(['form', 'layedit', 'laydate'], function(){
          ...
          form.on('select(aihao)', function(data){
                if(data.value == 3){
                    $(".aihao").css('display','block');
                }else{
                    $(".aihao").css('display','none');
                }
            });
          //日期
          laydate.render({
