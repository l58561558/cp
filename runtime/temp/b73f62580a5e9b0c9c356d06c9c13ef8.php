<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\phpStudy\WWW\cp/application/adminz\view\authority\edit.html";i:1513666872;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right">
                            <a href="<?php echo url('authority/index'); ?>" class="btn btn-link btn-sm"><i class="fa fa-angle-double-left"></i>&nbsp;返回列表</a>
                        </div>
                    </div>
                    ...
                    <form id="form_submit" enctype="multipart/form-data" class="layui-form layui-form-pane" action="" method="post">
                        <div class="box-body" id="tab_base">
                                ...
                                <div class="layui-input-block">
                                    <select name="pid" class="form-control">
                                        ...
                                        <?php if(is_array((isset($authority_list) && ($authority_list !== '')?$authority_list:array())) || (isset($authority_list) && ($authority_list !== '')?$authority_list:array()) instanceof \think\Collection || (isset($authority_list) && ($authority_list !== '')?$authority_list:array()) instanceof \think\Paginator): $i = 0; $__LIST__ = (isset($authority_list) && ($authority_list !== '')?$authority_list:array());if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                            <option value="<?php echo $vo['authority_id']; ?>" <?php echo $vo['authority_id']==$authority['pid']?'selected':''; ?>><?php echo $vo['name']; ?></option>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="name" lay-verify="required" class="layui-input" placeholder="权限名称" value="<?php echo $authority['name']; ?>">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">权限编码(英文)</label>
                                <div class="layui-input-block">
                                    <input type="text" name="code" lay-verify="required" class="layui-input" placeholder="权限编码(英文)" value="<?php echo $authority['code']; ?>">
                                </div>
                            </div>                           
                            <div class="layui-form-item">
                                <label class="layui-form-label">排序</label>
                                <div class="layui-input-block">
                                    <input type="text" name="sort_order" lay-verify="required" class="layui-input" placeholder="排序" value="<?php echo $authority['sort_order']; ?>" >
                                </div>
                            </div></div>
                        </div>
                        <div class="form-group" style="margin-left:10px;">
                            ...
                            <label for="enable_yes" style="padding-left:10px;">
                                <input <?php echo !empty($authority['is_enable'])?'checked':''; ?> type="checkbox" id="enable_yes" name="is_enable" value="1"  /> 启用
                            </label>
                        </div>
                        <div class="box-footer form-action" >
                            <input type="hidden" name="authority_id" value="<?php echo $authority['authority_id']; ?>" />
                            <button type="submit" class="layui-btn">添加</button>
                            <label for="jump_list" style="margin-left: 15px;"><input checked type="checkbox" data-url="<?php echo url('authority/index'); ?>" id="jump_list" value="1" >返回列表页</label>
                        </div>
                    </form>
                </div>
            </div>
