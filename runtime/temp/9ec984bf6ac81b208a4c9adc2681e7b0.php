<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\phpStudy\WWW\cp/application/adminz\view\authority\add.html";i:1513666686;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                    ...
                    <form id="form_submit" enctype="multipart/form-data" class="layui-form layui-form-pane" action="" method="post">
                        <div class="box-body" id="tab_base">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="name" lay-verify="required" class="layui-input" placeholder="权限名称" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">权限编码(英文)</label>
                                <div class="layui-input-block">
                                    <input type="text" name="code" lay-verify="required" class="layui-input" placeholder="权限编码(英文)" value="" >
                                </div>
                            </div>
                        ...
                        <div class="box-footer form-action" >
                            ...
                            <label for="jump_list" style="margin-left: 15px;"><input type="checkbox" data-url="<?php echo url('authority/index'); ?>" id="jump_list" value="1" >返回列表页</label>
                        </div>
                    </form>
                </div>
            </div>
