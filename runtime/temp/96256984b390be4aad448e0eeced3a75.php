<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\phpStudy\WWW\cp/application/adminz\view\nba\index.html";i:1545616005;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1545616011;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
				...
				<div class="box">
					<div class="box-header with-border">
						...
						<div class="pull-right">
							<a href="<?php echo url('reptile/games/addBasketball'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;生成赛事</a>
							<a href="<?php echo url('nba/add'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;添加赛事</a>
						</div>
		            </div>
...
<script type="text/javascript">
	...
	function getData(p){
		if(p==undefined || p<1)
			p = 1;
		$.post("<?php echo url('nba/get_nba_list'); ?>",{page:p},function(res){
			if(res.code == 1){
