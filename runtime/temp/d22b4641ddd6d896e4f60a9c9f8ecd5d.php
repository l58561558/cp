<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\phpStudy\WWW\cp/application/adminz\view\football\edit.html";i:1545183304;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1545183312;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <div class="box">
                    ...
                    <form id="form_submit" enctype="multipart/form-data" class="layui-form layui-form-pane" action="" method="post">
                        <div class="box-body" id="tab_base">
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label">上半场比分</label>
                                <div class="layui-input-block">
                                    <input type="text" name="top_score" value="<?php echo $data['top_score']; ?>" placeholder="上半场比分" lay-verify="required" class="layui-input" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">最终比分</label>
                                <div class="layui-input-block">
                                    <input type="text" name="down_score" value="<?php echo $data['down_score']; ?>" placeholder="最终比分" lay-verify="required" class="layui-input" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">让球数</label>
                                <div class="layui-input-block">
                                    <input type="text" name="let_score" value="<?php echo $data['let_score']; ?>" placeholder="让球数" lay-verify="required" class="layui-input" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">投注截止时间</label>
                                <div class="layui-input-block">
                                    <input type="text" id="date" name="end_time" value="<?php if(!empty($data['end_time'])): ?><?php echo $data['end_time']; endif; ?>" class="layui-input" placeholder="比赛结束时间" >
                                </div>
                            </div>
                        ...
                        <div class="layui-input-block">
                            ...
                            <label for="jump_list" style="margin-left: 15px;"><input type="checkbox" data-url="<?php echo url('football/index'); ?>" id="jump_list" value="1" >返回列表页</label>
                        </div>
                    </form>
                </div>
            </div>
