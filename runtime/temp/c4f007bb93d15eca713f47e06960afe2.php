<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\phpStudy\WWW\cp/application/adminz\view\login\index.html";i:1545616004;}*/ ?>
        ...
        <div class="main" style="padding-top:10px;">
        	<form class="login-form"  method="post">	
	            <table width="270" border="0" align="center" cellpadding="0" cellspacing="0" >
	                <tr>
	                    <td height="50" colspan="2"><input name="username" value="<?php echo (isset($remember) && ($remember !== '')?$remember:''); ?>" type="text" / class="name_input" placeholder="用户名"></td>
	                </tr>
	                <tr>
	                ...
	                <tr>
	                    <td height="30" colspan="2">
	                        <span class="fxk"><input type="checkbox" name="checkbox" <?php if($remember): ?>checked="checked"<?php endif; ?>  />记住用户名</span>
	...
	<script>
		$(function(){
			...
			$(".login_bnt").click(function(){
				...
				$.post("<?php echo url('login/login'); ?>",{username:username,password:password,yzm:yzm,checkbox:checkbox},function(data){
					if(data.status == 1){
