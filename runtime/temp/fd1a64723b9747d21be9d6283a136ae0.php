<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\phpStudy\WWW\cp/application/adminz\view\node\index.html";i:1512974978;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586793;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
				...
				<div class="box">
					<div class="box-header with-border">
		              ...
		              <div class="pull-right">
			              <a href="<?php echo url('node/add'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;添加节点</a>
			          </div>
		            </div>
  ...
  var element = layui.element;
	...
	<script type="text/javascript">
		function getData(p){
			if(p==undefined || p<1)
				p = 1;
			$.post("<?php echo url('node/get_node_list'); ?>",{page:p},function(res){
				if(res.code == 1){
