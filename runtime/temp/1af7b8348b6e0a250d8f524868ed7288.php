<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\phpStudy\WWW\cp/application/adminz\view\sell\order.html";i:1545183314;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1545183312;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  var element = layui.element;
	...
	<script type="text/javascript">
		...
		function getData(p){
			...
			$.post("<?php echo url('sell/get_order_list'); ?>",{page:p,result:result},function(res){
				if(res.code == 1){
