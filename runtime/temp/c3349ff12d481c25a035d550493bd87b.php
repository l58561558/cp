<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\phpStudy\WWW\cp/application/adminz\view\nba\add.html";i:1545616004;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1545616011;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                        ...
                        <div class="box-body" id="tab_base">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="game_no" lay-verify="required" class="layui-input" placeholder="比赛名称" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">比赛名称</label>
                                <div class="layui-input-block">
                                    <input type="text" name="game_name" lay-verify="required" class="layui-input" placeholder="比赛名称" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">客队</label>
                                <div class="layui-input-block">
                                    <input type="text"  name="road_team" lay-verify="required" class="layui-input" placeholder="客队" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">主队</label>
                                <div class="layui-input-block">
                                    <input type="text"  name="home_team" lay-verify="required" class="layui-input" placeholder="主队" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">总分</label>
                                <div class="layui-input-block">
                                    <input type="text" name="total_score" placeholder="总分" lay-verify="required" class="layui-input" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">让分数</label>
                                <div class="layui-input-block">
                                    <input type="text" name="let_score" placeholder="“-”主胜“+”客胜" lay-verify="required" class="layui-input" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">投注结束时间</label>
                                <div class="layui-input-block">
                                    <input type="text" id="date" name="end_time" lay-verify="required" class="layui-input" placeholder="投注结束时间" >
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div style="width: 130px;float: left;margin-bottom: 15px">
                                    <label class="layui-form-label"><?php echo $info['code_name']; ?></label>
                                    <input style="width: 120px;text-align: center;" type="text" name="<?php echo $info['code']; ?>" lay-verify="required" placeholder="<?php echo $info['code_name']; ?>赔率" class="layui-input"> 
                                </div>
