<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\phpStudy\WWW\cp/application/adminz\view\nba\look.html";i:1543839514;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                        ...
                        <div class="layui-row layui-col-space15">
                            <div class="layui-col-md12">
                                <div class="layui-card">
                                    ...
                                    <div class="layui-card-body">获胜队伍 ： <?php echo (isset($data['win_team']) && ($data['win_team'] !== '')?$data['win_team']:'-'); ?></div>
                                    <div class="layui-card-body">总分 ： <?php echo (isset($data['total_score']) && ($data['total_score'] !== '')?$data['total_score']:'-'); ?></div>
                                    <div class="layui-card-body">让分数 ： <?php echo (isset($data['let_score']) && ($data['let_score'] !== '')?$data['let_score']:'-'); ?></div>
