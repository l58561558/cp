<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\phpStudy\WWW\cp/application/adminz\view\bank_card\index.html";i:1531380446;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586793;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
				...
				<div class="box">
					<div class="box-header with-border">
		              	...
		              	<!-- <div class="pull-right">
			              	<a href="<?php echo url('order/add'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;添加文章</a>
			          	</div> -->
		            </div>
  ...
  var element = layui.element;
	...
	<script type="text/javascript">
		...
		function getData(p){
			...
			$.post("<?php echo url('bank_card/get_bank_card_list'); ?>",{page:p},function(res){
				if(res.code == 1){
