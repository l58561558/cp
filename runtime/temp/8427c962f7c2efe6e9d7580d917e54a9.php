<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\phpStudy\WWW\cp/application/adminz\view\nba\order_info.html";i:1545616007;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1545616011;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right">
                            <a href="<?php echo url('nba/nba_order'); ?>" class="btn btn-link btn-sm"><i class="fa fa-angle-double-left"></i>&nbsp;返回列表</a>
                        </div>
                    </div>
                    <table class="layui-table" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;"><?php echo $item['home_score']; ?> : <?php echo $item['road_score']; ?></td>
                                <td style="text-align: center;">
                                    <?php if(is_array($item['tz_result']) || $item['tz_result'] instanceof \think\Collection || $item['tz_result'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['tz_result'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?>
                                        <?php echo $info['cate_name']; if($info['cate_code'] == 'let_score_win_road' or $info['cate_code'] == 'let_score_win_home'): ?>(<?php echo $item['let_score']; ?>)<?php endif; if($info['cate_code'] == 'total_big' or $info['cate_code'] == 'total_small'): ?>(<?php echo $item['total_score']; ?>)<?php endif; ?>
                                        <?php echo $info['cate_odds']; if($info['is_win'] == 0): ?><span style="color: #ce6a14">(未开奖)</span><?php endif; if($info['is_win'] == 1): ?><span style="color: green">(正确)</span><?php endif; if($info['is_win'] == 2): ?><span style="color: red">(不正确)</span><?php endif; ?>
                                        &nbsp;&nbsp;
                                ...
                                <td style="text-align: center;">
                                    <?php if(is_array($item['win_result']) || $item['win_result'] instanceof \think\Collection || $item['win_result'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['win_result'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                                        <?php echo $cate['cate_name']; if($cate['cate_code'] == 'let_score_win_road' or $cate['cate_code'] == 'let_score_win_home'): ?>(<?php echo $item['let_score']; ?>)<?php endif; if($cate['cate_code'] == 'total_big' or $cate['cate_code'] == 'total_small'): ?>(<?php echo $item['total_score']; ?>)<?php endif; ?>
                                        <?php echo $cate['cate_odds']; ?>&nbsp;&nbsp;
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </td>
                                <td style="text-align: center;">
