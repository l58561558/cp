<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\phpStudy\WWW\cp/application/adminz\view\order\order_info.html";i:1544421481;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586793;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right">
                            <a href="<?php echo url('order/index'); ?>" class="btn btn-link btn-sm"><i class="fa fa-angle-double-left"></i>&nbsp;返回列表</a>
                        </div>
                    </div>
