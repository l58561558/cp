<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\phpStudy\WWW\cp/application/adminz\view\admin\edit.html";i:1545183299;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1545183312;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                    ...
                    <form id="form_submit" enctype="multipart/form-data" class="layui-form layui-form-pane" action="" method="post">
                        <div class="box-body" id="tab_base">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <select name="role_id" lay-filter="aihao">
                                        <?php if(is_array((isset($role_list) && ($role_list !== '')?$role_list:array())) || (isset($role_list) && ($role_list !== '')?$role_list:array()) instanceof \think\Collection || (isset($role_list) && ($role_list !== '')?$role_list:array()) instanceof \think\Paginator): $i = 0; $__LIST__ = (isset($role_list) && ($role_list !== '')?$role_list:array());if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                            <option value="<?php echo $vo['role_id']; ?>" <?php echo $vo['role_id']==$admin['role_id']?'selected':''; ?>><?php echo $vo['role_name']; ?></option>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" datatype="*" nullmsg="请输入登录名"  name="login_name" lay-verify="required" class="layui-input" placeholder="登录名" value="<?php echo $admin['login_name']; ?>">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">姓名</label>
                                <div class="layui-input-block">
                                    <input type="text" datatype="*" nullmsg="请输入姓名" name="nickname" lay-verify="required" class="layui-input" placeholder="姓名" value="<?php echo $admin['nickname']; ?>">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">登录密码</label>
                                <div class="layui-input-block">
                                    <input type="text" datatype="*" nullmsg="请输入登录密码" name="login_pass" lay-verify="required" class="layui-input" placeholder="登录密码" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">手机号码</label>
                                <div class="layui-input-block">
                                    <input type="text" datatype="*" nullmsg="请输入手机号码" name="mobile" lay-verify="required" class="layui-input" placeholder="手机号码" value="<?php echo $admin['mobile']; ?>">
                                </div>
                            </div>
                            <!-- <div class="layui-form-item">
                                <label class="layui-form-label">状态</label>
                                <div class="layui-input-block">
                                    <input type="radio" id="status_yes" name="status" value="1" title="启用" <?php echo $admin['status']==1?'checked':''; ?>>
                                    <div class="layui-unselect layui-form-radio <?php echo $admin['status']==1?'layui-form-radioed':''; ?>">
                                        <i class="layui-anim layui-icon layui-anim-scaleSpring"></i>
                                        <div>启用</div>
                                    </div>
                                    <input type="radio" id="status_no" name="status" value="0" title="禁用" <?php echo $admin['status']==0?'checked':''; ?>>
                                    <div class="layui-unselect layui-form-radio <?php echo $admin['status']==0?'layui-form-radioed':''; ?>">
                        ...
                        <div class="layui-input-block">
                            ...
                            <label for="jump_list" style="margin-left: 15px;"><input checked type="checkbox" data-url="<?php echo url('admin/index'); ?>" id="jump_list" value="1" >返回列表页</label>
                        </div>
                    </form>
                </div>
            </div>
