<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\phpStudy\WWW\cp/application/adminz\view\ads\edit.html";i:1528204920;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right">
                            <a href="<?php echo url('ads/index'); ?>" class="btn btn-link btn-sm"><i class="fa fa-angle-double-left"></i>&nbsp;返回列表</a>
                        </div>
                    </div>
                    ...
                    <form id="form_submit" enctype="multipart/form-data" class="layui-form layui-form-pane" action="" method="post">
                      <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                          <select name="position_id" lay-filter="aihao">
                             <?php if(is_array((isset($position_list) && ($position_list !== '')?$position_list:array())) || (isset($position_list) && ($position_list !== '')?$position_list:array()) instanceof \think\Collection || (isset($position_list) && ($position_list !== '')?$position_list:array()) instanceof \think\Paginator): $i = 0; $__LIST__ = (isset($position_list) && ($position_list !== '')?$position_list:array());if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $vo['position_id']; ?>" <?php echo $vo['position_id']==$ads['position_id']?'selected':''; ?>><?php echo $vo['position_name']; ?></option>
                      ...
                      <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                          <input type="text" name="title" value="<?php echo $ads['title']; ?>" lay-verify="required" placeholder="广告图片标题" autocomplete="off" class="layui-input">
                        </div>
                      </div> 
                      <div class="layui-form-item">
                        <label class="layui-form-label">广告描述</label>
                        <div class="layui-input-block">
                          <input type="text" name="desc" value="<?php echo $ads['desc']; ?>" lay-verify="required" placeholder="广告图片描述" autocomplete="off" class="layui-input">
                        </div>
                      </div> 
                      <div class="layui-form-item">
                        ...
                        <img style="width: 150px;height: 50px;" name="pic_img" data-content='<img src="__UPLOADS__/ads/<?php echo $ads['pic']; ?>" />' src="__UPLOADS__/ads/<?php echo $ads['pic']; ?>" />
                      </div>
                      <div class="layui-form-item">
                        <label class="layui-form-label">跳转链接</label>
                        <div class="layui-input-block">
                          <input type="text" name="url" value="<?php echo $ads['url']; ?>" lay-verify="required" placeholder="跳转链接" autocomplete="off" class="layui-input">
                        </div>
                      </div> 
                      <div class="layui-form-item">
                        <label class="layui-form-label">排序</label>
                        <div class="layui-input-block">
                          <input type="text" name="sort_order" value="<?php echo $ads['sort_order']; ?>" lay-verify="required" placeholder="排序" autocomplete="off" class="layui-input"><span class="note">*大到小</span>
                        </div>
                      </div> 
                      </div>
                      <div class="layui-input-block">
                          <button class="layui-btn" lay-submit=""  lay-filter="demo1">保存</button>
                          <label for="jump_list" style="margin-left: 15px;"><input type="checkbox" data-url="<?php echo url('ads/index'); ?>" id="jump_list" value="1" >返回列表页</label>
                        </div>
                    </form>
                </div>
            </div>
