<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\phpStudy\WWW\cp/application/adminz\view\sell\user.html";i:1545183315;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1545183312;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-header with-border">
		              	...
		              	<h3 style="margin-left: 20px" class="box-title">我的邀请码 : <?php echo (isset($invite_code) && ($invite_code !== '')?$invite_code:'-'); ?></h3>
		            </div>
		            <div class="pull-left">
...
<script type="text/javascript">
	...
	function getData(){
		...
		$.post("<?php echo url('sell/get_user_list'); ?>",result,function(res){
			if(res.code == 1){
