<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\phpStudy\WWW\cp/application/adminz\view\role\edit.html";i:1513664594;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                    ...
                    <form id="form_submit" enctype="multipart/form-data" class="layui-form layui-form-pane" action="" method="post">
                        <div class="box-body" id="tab_base">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="role_name" value="<?php echo $role['role_name']; ?>" class="layui-input" lay-verify="required" placeholder="位置名称" >
                                </div>
                            </div>
                        ...
                        <div class="form-group" style="margin-left: 12px">
                            ...
                            <label for="enable_yes" style="padding-left:10px;">
                                <input <?php echo !empty($role['is_enable'])?'checked':''; ?> type="checkbox" id="enable_yes" name="is_enable" value="1"  /> 启用
                            </label>
                        </div>
                        <div class="box-footer form-action">
                            <input type="hidden" name="role_id" value="<?php echo $role['role_id']; ?>" />
                            <button type="submit" class="btn btn-primary">添加</button>
                            <label for="jump_list" style="margin-left: 15px;"><input checked type="checkbox" data-url="<?php echo url('role/index'); ?>" id="jump_list" value="1" >返回列表页</label>
                        </div>
                    </form>
                </div>
            </div>
