<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\phpStudy\WWW\cp/application/adminz\view\football\index.html";i:1545616002;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1545616011;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
				...
				<div class="box">
					<div class="box-header with-border">
						...
						<div class="pull-right">
							<a href="<?php echo url('reptile/games/addFootball'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;生成赛事</a>
							<a href="<?php echo url('football/add'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;添加赛事</a>
						</div>
		            </div>
...
<script type="text/javascript">
	$(".over").click(function(){
		...
		$.ajax({
			url:"<?php echo url('football/fb_over'); ?>",
			type:'get',
			data:{id:id},
	...
	function getData(p){
		if(p==undefined || p<1)
			p = 1;
		$.post("<?php echo url('football/get_fb_list'); ?>",{page:p},function(res){
			if(res.code == 1){
