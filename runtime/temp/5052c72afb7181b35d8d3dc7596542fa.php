<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\phpStudy\WWW\cp/application/adminz\view\system\admin_site.html";i:1512977362;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">网站后台配置</h3>
                        <!-- <div class="pull-right">
                            <a href="<?php echo url('focus/lists'); ?>" class="btn btn-link btn-sm"><i class="fa fa-angle-double-left"></i>&nbsp;返回列表</a>
                        </div> -->
                    </div>
                    <form id="form_submit" method='post' action="<?php echo url('system/admin_site'); ?>" enctype="multipart/form-data">
                        <div class="box-body">
                             <div class="box-body">
                            <div class="form-group">
                                <label>网站后台名称</label>
                                <textarea class="form-control" type="text" name="title" data-options="required:true" style="resize: none;"><?php echo $config['admin_title']; ?></textarea>
                            </div>
                        </div>
                        </div>
