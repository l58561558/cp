<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\phpStudy\WWW\cp/application/adminz\view\authority\index.html";i:1512976398;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
				...
				<div class="box">
					<div class="box-header with-border">
		              ...
		              <div class="pull-right">
			              <a href="<?php echo url('authority/add'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;添加权限</a>
			          </div>
		            </div>
  ...
  var element = layui.element;
	...
	<script type="text/javascript">
		function getData(p){
			if(p==undefined || p<1)
				p = 1;
			$.post("<?php echo url('authority/get_authority_list'); ?>",{page:p},function(res){
				if(res.code == 1){
