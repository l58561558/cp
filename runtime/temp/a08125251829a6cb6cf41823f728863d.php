<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\phpStudy\WWW\cp/application/adminz\view\user\index.html";i:1545616024;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1545616011;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
				...
				<div class="box">
		            <div class="box-header with-border">
                        <div class="pull-left">
                            ...
                            <input type="text" placeholder="手机号码 (选填)" class="phone">
                            <input type="text" placeholder="用户名 (选填)" class="user_name">
...
$(".layui-btn").click(function(){
	...
	function getData(p){
		...
		$.post("<?php echo url('user/get_user_list'); ?>",{page:p,result:result},function(res){
			if(res.code == 1){
