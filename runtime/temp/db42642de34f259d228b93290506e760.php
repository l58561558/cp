<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\phpStudy\WWW\cp/application/adminz\view\nba\nba_order.html";i:1540205400;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586793;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<script type="text/javascript">
	function getData(p){
		...
		$.post("<?php echo url('nba/get_nba_order'); ?>",{page:p},function(res){
			if(res.code == 1){
