<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\phpStudy\WWW\cp/application/adminz\view\ads\index.html";i:1527781620;s:59:"D:\phpStudy\WWW\cp/application/adminz\view\public\base.html";i:1539586792;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
				...
				<div class="box">
					<div class="box-header with-border">
		              ...
		              <div class="pull-right">
			              <a href="<?php echo url('ads/add'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;添加广告</a>
			          </div>
		            </div>
  ...
  var element = layui.element;
	...
	<script type="text/javascript">
		function getData(p){
			...
			$.post("<?php echo url('ads/get_ads_list'); ?>",{page:p,position_id:position_id},function(res){
				if(res.code == 1){
